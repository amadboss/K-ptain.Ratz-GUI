                                        ...
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="ip" value="IP DU SERVER :" size="12" >
                                                    </form>
                                                ...
                                                <td class="last-seen"><a href="http://<?php $first = requet1()[0]; print_r($first['ip']); ?>:56000/html"> <img src="assets/images/icon/camera.ico" alt="icon"> </td>
                                            ...
                                            <tr>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="ip1" value="IP DU SERVER :" size="12">
                                                    </form>
                                                ...
                                                <td class="os"><img src="assets/images/icon/dashboard/win10.png" alt="icon"></td>
                                                <td class="last-seen"><a href="http://<?php $first = requet2()[0]; print_r($first['ip']); ?>:56000/html"> <img src="assets/images/icon/camera.ico" alt="icon"> </td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="ip2" value="IP DU SERVER :" size="12">
                                                    </form>
                                                ...
                                                <td class="os"><img src="assets/images/icon/dashboard/win10.png" alt="icon"></td>
                                                <td class="last-seen"><a href="http://<?php $first = requet3()[0]; print_r($first['ip']); ?>:56000/html"> <img src="assets/images/icon/camera.ico" alt="icon"> </td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                ...
                                                <p>
                                                    ...
                                                    <input type="text" name="ip3" value="IP DU SERVER :" size="12">
                                                    </form>
                                                ...
                                                <td class="os"><img src="assets/images/icon/dashboard/win10.png" alt="icon"></td>
                                                <td class="last-seen"><a href="http://<?php $first = requet4()[0]; print_r($first['ip']); ?>:56000/html"> <img src="assets/images/icon/camera.ico" alt="icon"> </td>
                                                <td class="stats-chart">
